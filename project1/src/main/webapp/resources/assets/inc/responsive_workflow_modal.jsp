<!-- responsive_workflow_modal modal start-->
    <div class="modal fade" id="responsive_workflow_modal" tabindex="1" aria-labelledby="wfDetail" aria-hidden="true">
										...
										<div class="row">
						                    ...
						                    <div class="col-md-6 col-lg-2" style="border-bottom: 1px solid rgba(0,0,0,0.1);">
						                     ...
						                     <div class="col-md-6 col-lg-2" style="border-bottom: 1px solid rgba(0,0,0,0.1);">
												<div class="form-group" >
									                ...
									                <a href="#">
										                <div class="form-group" id="getSender" style="height:80px; display: flex;">
						                    ...
						                    <div class="col-md-6 col-lg-2" style="border-bottom: 1px solid rgba(0,0,0,0.1);">
												<div class="form-group">
									                ...
									                <a href="#">
									            		<div class="form-group" id="getReceiver" style="height:80px; display: flex;">
									                    	<div style="display: flex; ">
									                    		<div style="display: flex; flex:0.3; align-items: center; justify-content: center;">
									                    			<img src="${pageContext.request.contextPath }/resources/assets/img/jm_denis.jpg"
														        	alt="img1" 
										...
										<div class="row">
						                    ...
						                    <div class="col-md-6 col-lg-4" style="display: flex; flex-direction:column;">
						                    	<div id="receivers" style="display:flex; flex-direction:column; flex:0.5; justify-content: center;">
							                    	 <!-- 1차승인자 start -->
								                     <div class="form-group" id="getReceiver_1st" style="height:100px; display: flex; flex-direction:column; ">
								                     	<div style="flex:0.2;">
								                     		FIRST RECEIVER
								                     	</div>
								                     	<a href="#">
...
<!-- responsive_workflow_modal modal end-->